...
const BUY_ADJUSTMENTS: Map<u8, Decimal> = Map::new("buy_adjustments_v7");
const SELL_ADJUSTMENTS: Map<u8, Decimal> = Map::new("sell_adjustments_v7");
const BUY_ADJUSTMENTS_UPDATED_AT: Item<Timestamp> = Item::new("buy_adjustments_updated_at_v7");
const SELL_ADJUSTMENTS_UPDATED_AT: Item<Timestamp> = Item::new("buy_adjustments_updated_at_v7");

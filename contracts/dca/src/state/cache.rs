...
pub const VAULT_CACHE: Item<VaultCache> = Item::new("vault_cache_v5");
...
pub const SWAP_CACHE: Item<SwapCache> = Item::new("swap_cache_v5");
...
pub const PROVIDE_LIQUIDITY_CACHE: Item<ProvideLiquidityCache> =
    Item::new("provide_liquidity_cache_v5");
